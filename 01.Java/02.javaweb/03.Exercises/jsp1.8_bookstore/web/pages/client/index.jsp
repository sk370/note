...
<%--                <span> </span>--%>
<%--                <div>--%>
<%--                    <span style="color: red" id="lastItem">当前购物车为空</span>--%>
<%--                </div>--%>
...
<%--                </div>--%>
                ...
                <div>
                    您刚刚将<span style="color: red" id="lastItem">${sessionScope.lastItem}</span>加入到了购物车中
                </div>
            </c:if>
        </div>
        ...
        <c:forEach items="${requestScope.page.items}" var="book">
            <div class="b_list">
                ...
                <div class="book_info">
                    ...
                    <div class="book_add">
                        <button itemid="${book.id}" class="add_to_cart">加入购物车</button>
                    </div>
                </div>
            </div>
        </c:forEach>
